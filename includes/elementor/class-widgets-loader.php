...
class Widgets_Loader
{
   ...
   * @access public
   * @static
   * @return Widgets_Loader The single instance of the loader
   */
  public static function get_instance(): Widgets_Loader
  {
  ...
  {
    return [
      "leadgen-form" => "LeadGen_Form_Widget",
    ];
  }
  ...
  private function include_widget_files(): void
  {
    ...
    foreach ($widget_list as $widget_key => $widget_class) {
      $widget_file = LEADGEN_APP_FORM_PLUGIN_PATH . "includes/elementor/widgets/class-{$widget_key}-widget.php";
